            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <Badge variant="outline" className="text-[10px] bg-slate-800">
                ...
                <div className="divide-y divide-slate-700/50">
                  {presetsInCampus
                    ...
                    .map((preset, idx) => {
                      ...
                      const occupants = vigilantes.filter(
                        (v) =>
                          v.campus === preset.campus &&
                          v.setor === preset.setor,
                      );
                          ...
                          <div className="flex-1 flex flex-col gap-2">
                            {isOccupied ? (
                              ...
                              <div className="bg-slate-800/50 border border-dashed border-slate-700 rounded p-2 flex items-center justify-between group hover:border-slate-500 transition-colors">
                                ...
                                <select
                                  className="bg-transparent text-xs text-slate-300 outline-none w-48 text-right cursor-pointer hover:text-white [&>option]:bg-slate-800 [&>option]:text-white"
                                  onChange={(e) => {
                                    if (e.target.value)
                                      handleAssign(preset, e.target.value);
                                  }}
                                  value=""
                                >
